#ifndef wasm_dynamic_INCLUDE_GUARD_MIR_PRINTER
#define wasm_dynamic_INCLUDE_GUARD_MIR_PRINTER
...
namespace mir
{
  ...
  class EntityNameWriter
  {
    ...
    void prepareEntities(T const &Entities);
  ...
  class MIRIteratorWriter
  {
    ...
    MIRIteratorWriter &forwardE(ArgType &&Arg);
    template <typename ArgType>
    MIRIteratorWriter &forwardL(ArgType &&Arg);
