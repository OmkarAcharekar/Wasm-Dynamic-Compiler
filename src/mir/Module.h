#ifndef wasm_dynamic_INCLUDE_GUARD_MIR_MODULE
#define wasm_dynamic_INCLUDE_GUARD_MIR_MODULE
...
namespace mir
{
  ...
  class DataSegment : public ASTNode,
  ...
  class ElementSegment : public ASTNode,
