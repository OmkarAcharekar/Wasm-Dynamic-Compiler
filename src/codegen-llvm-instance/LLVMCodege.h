#ifndef wasm_dynamic_INCLUDE_GUARD_CODEGEN_LLVM_CTX_LLVM_CODEGEN
#define wasm_dynamic_INCLUDE_GUARD_CODEGEN_LLVM_CTX_LLVM_CODEGEN
...
namespace codegen::llvm_instance
{
  ...
  private:
     ...
     * __wasm_dynamic_memory_metadata_t *
     * __wasm_dynamic_table_metadata_t *
     * __wasm_dynamic_global_metadata_t *
     * __wasm_dynamic_function_metadata_t *
  ...
  public:
    ...
    /* __wasm_dynamic_instance_t * */ llvm::PointerType *getInstancePtrTy();

    /* __wasm_dynamic_memory_metadata_t   */ llvm::StructType *getMemoryMetadataTy();
    /* __wasm_dynamic_table_metadata_t    */ llvm::StructType *getTableMetadataTy();
    /* __wasm_dynamic_global_metadata_t   */ llvm::StructType *getGlobalMetadataTy();
    /* __wasm_dynamic_function_metadata_t */ llvm::StructType *getFunctionMetadataTy();

    /* __wasm_dynamic_memory_t *   */ llvm::PointerType *getMemoryPtrTy();
    /* __wasm_dynamic_table_t *    */ llvm::PointerType *getTablePtrTy();
    /* __wasm_dynamic_global_t *   */ llvm::PointerType *getGlobalPtrTy();
    /* __wasm_dynamic_function_t * */ llvm::PointerType *getFunctionPtrTy();
