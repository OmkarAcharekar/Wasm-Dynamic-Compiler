...
namespace codegen::llvm_instance
{
  ...
  {
    auto *InstanceTy = createNamedStructTy("__wasm_dynamic_instance_t");
    std::vector<llvm::Type *> InstanceFields;

    auto *MemoryMetadataTy = createNamedStructTy("__wasm_dynamic_memory_metadata_t");
    auto *TableMetadataTy = createNamedStructTy("__wasm_dynamic_table_metadata_t");
    auto *GlobalMetadataTy = createNamedStructTy("__wasm_dynamic_global_metadata_t");
    auto *FunctionMetadataTy = createNamedStructTy("__wasm_dynamic_function_metadata_t");
    ...
    auto *MemoryOpaqueTy = declareOpaqueTy("__wasm_dynamic_memory_t");
    ...
    auto *TableOpaqueTy = declareOpaqueTy("__wasm_dynamic_table_t");
    ...
    auto *GlobalOpaqueTy = declareOpaqueTy("__wasm_dynamic_global_t");
    ...
    auto *FunctionOpaqueTy = declareOpaqueTy("__wasm_dynamic_function_t");
  ...
  namespace
  {
    namespace detail
    {
      struct InitExprTranslationVisitor : mir::InitExprVisitorBase<InitExprTranslationVisitor, llvm::Value *>
      {
        ...
        llvm::Value *operator()(mir::initializer::Constant const *InitExpr)
        {
          ...
          {
          case VKind::I32:
            return ELayout.getI32Constant(InitExpr->asI32());
          case VKind::I64:
            return ELayout.getI64Constant(InitExpr->asI64());
          case VKind::F32:
            return ELayout.getF32Constant(InitExpr->asF32());
          case VKind::F64:
            return ELayout.getF64Constant(InitExpr->asF64());
          default:
            utility::unreachable();
          }
        }
  ...
  void EntityLayout::setupMemoryMetadata()
  {
    ...
    setupMetadata(
        "__wasm_dynamic_memory_metadata",
  ...
  void EntityLayout::setupGlobalMetadata()
  {
    ...
    setupMetadata(
        "__wasm_dynamic_global_metadata",
  ...
  void EntityLayout::setupFunctionMetadata()
  {
    ...
    setupMetadata(
        "__wasm_dynamic_function_metadata",
        /* Sizes    */ Entities.size(), Imports.size(), Exports.size(),
        /* Entities */ setupArrayGlobal(EntityTy, Entities),
        /* Imports  */ setupArrayGlobal(ImportTy, Imports),
        /* Exports  */ setupArrayGlobal(ExportTy, Exports));
  ...
  void EntityLayout::setupInitialization()
  {
    ...
    auto *InitializationFn = llvm::Function::Create(
        ...
        /* Name    */ "__wasm_dynamic_initialize",
        /* Parent  */ Target);
    ...
    for (auto const &Memory : Source.getMemories())
    {
      for (auto const *DataSegment : Memory.getInitializers())
      {
        ...
        Builder.CreateCall(
            getBuiltin("__wasm_dynamic_memory_guard"), {MemoryBase, GuardAddress});
    ...
    for (mir::Table const &Table : Source.getTables())
    {
      for (mir::ElementSegment const *ElementSegment : Table.getInitializers())
      {
        ...
        Builder.CreateCall(
            getBuiltin("__wasm_dynamic_table_guard"), {TableBase, GuardIndex});

        Builder.CreateCall(
            getBuiltin("__wasm_dynamic_table_set"),
  ...
  {
    /* void __wasm_dynamic_memory_guard(__wasm_dynamic_memory_t * mem, std::uint32_t address) */
    auto *MemoryGuardTy = llvm::FunctionType::get(
        getVoidTy(), {getMemoryPtrTy(), getI32Ty()}, false);
    llvm::Function::Create(
        /* Type    */ MemoryGuardTy,
        /* Linkage */ llvm::GlobalValue::LinkageTypes::ExternalLinkage,
        /* Name    */ "__wasm_dynamic_memory_guard",
        /* Parent  */ Target);

    /* void __wasm_dynamic_table_guard(__wasm_dynamic_table_t *table, std::uint32_t index) */
    auto *TableGuardTy = llvm::FunctionType::get(
        getVoidTy(), {getTablePtrTy(), getI32Ty()}, false);
    llvm::Function::Create(
        /* Type    */ TableGuardTy,
        /* Linkage */ llvm::GlobalValue::LinkageTypes::ExternalLinkage,
        /* Name    */ "__wasm_dynamic_table_guard",
        /* Parent  */ Target);

    /* void __wasm_dynamic_table_set(
     *    __wasm_dynamic_table_t *table, std::uint32_t start, std::uint32_t size,
     *    __wasm_dynamic_function_t *pointers[], char const * types[])    */
    ...
    llvm::Function::Create(
        /* Type    */ TableSetTy,
        /* Linkage */ llvm::GlobalValue::LinkageTypes::ExternalLinkage,
        /* Name    */ "__wasm_dynamic_table_set",
        /* Parent  */ Target);

    /* __wasm_dynamic_function_t * __wasm_dynamic_table_get(
     *   __wasm_dynamic_table_t *table, std::uint32_t index, char const * expect_type) */
    ...
    llvm::Function::Create(
        /* Type    */ TableGetTy,
        /* Linkage */ llvm::GlobalValue::LinkageTypes::ExternalLinkage,
        /* Name    */ "__wasm_dynamic_table_get",
        /* Parent  */ Target);

    /* void __wasm_dynamic_unreachable() */
    auto *UnreachableTy = llvm::FunctionType::get(getVoidTy(), {}, false);
    llvm::Function::Create(
        /* Type    */ UnreachableTy,
        /* Linkage */ llvm::GlobalValue::LinkageTypes::ExternalLinkage,
        /* Name    */ "__wasm_dynamic_unreachable",
        /* Parent  */ Target);
  }
      ...
      mir::Global const &MGlobal)
  {
    ...
    if (MGlobal.hasName())
      GlobalPtr->setName(llvm::StringRef(MGlobal.getName()));
    return GlobalPtr;
  }
      ...
      mir::Memory const &MMemory)
  {
    ...
    if (MMemory.hasName())
      MemoryPtr->setName(llvm::StringRef(MMemory.getName()));
    return MemoryPtr;
  }
      ...
      const mir::Table &MTable)
  {
    ...
    if (MTable.hasName())
      TablePtr->setName(llvm::StringRef(MTable.getName()));
    return TablePtr;
  }
  ...
  {
    auto *InstanceTy = getNamedStructTy("__wasm_dynamic_instance_t");
    return llvm::PointerType::getUnqual(InstanceTy);
  }

  llvm::StructType *EntityLayout::getMemoryMetadataTy()
  {
    return getNamedStructTy("__wasm_dynamic_memory_metadata_t");
  }

  llvm::StructType *EntityLayout::getTableMetadataTy()
  {
    return getNamedStructTy("__wasm_dynamic_table_metadata_t");
  }

  llvm::StructType *EntityLayout::getGlobalMetadataTy()
  {
    return getNamedStructTy("__wasm_dynamic_global_metadata_t");
  }

  llvm::StructType *EntityLayout::getFunctionMetadataTy()
  {
    return getNamedStructTy("__wasm_dynamic_function_metadata_t");
  }

  llvm::PointerType *EntityLayout::getMemoryPtrTy()
  {
    auto *OpaqueTy = getOpaqueTy("__wasm_dynamic_memory_t");
    return llvm::PointerType::getUnqual(OpaqueTy);
  }

  llvm::PointerType *EntityLayout::getTablePtrTy()
  {
    auto *OpaqueTy = getOpaqueTy("__wasm_dynamic_table_t");
    return llvm::PointerType::getUnqual(OpaqueTy);
  }

  llvm::PointerType *EntityLayout::getGlobalPtrTy()
  {
    auto *OpaqueTy = getOpaqueTy("__wasm_dynamic_global_t");
    return llvm::PointerType::getUnqual(OpaqueTy);
  }

  llvm::PointerType *EntityLayout::getFunctionPtrTy()
  {
    auto *OpaqueTy = getOpaqueTy("__wasm_dynamic_function_t");
    return llvm::PointerType::getUnqual(OpaqueTy);
  }

  llvm::GlobalVariable *EntityLayout::getMemoryMetadata()
  {
    return Target.getGlobalVariable("__wasm_dynamic_memory_metadata");
  }

  llvm::GlobalVariable *EntityLayout::getTableMetadata()
  {
    return Target.getGlobalVariable("__wasm_dynamic_table_metadata");
  }

  llvm::GlobalVariable *EntityLayout::getGlobalMetadata()
  {
    return Target.getGlobalVariable("__wasm_dynamic_global_metadata");
  }

  llvm::GlobalVariable *EntityLayout::getFunctionMetadata()
  {
    return Target.getGlobalVariable("__wasm_dynamic_function_metadata");
  }
} // namespace codegen::llvm_instance
