#ifndef wasm_dynamic_INCLUDE_GUARD_PARSER_PARSER
#define wasm_dynamic_INCLUDE_GUARD_PARSER_PARSER
...
namespace parser
{
  ...
  namespace detail
  {
    struct WASMSectionOrderPolicy
    {
      ...
      void check(std::byte SectionMagicNumber)
      {
        ...
        if (SectionMagicNumber == 0x00_byte)
          return;
  ...
  void Parser<ReaderImpl, DelegateImpl>::parse()
  {
    ...
    while (Reader.hasMoreBytes())
    {
      ...
      {
      case 0x00:
        parseCustomSection(SectionSize);
        break;
      case 0x01:
        parseTypeSection();
        break;
  ...
  void Parser<ReaderImpl, DelegateImpl>::parseInstruction()
  {
    ...
    case 0x0c:
      Delegate.onInstBr(Reader.readLabelIDX());
      break;
    case 0x0d:
      Delegate.onInstBrIf(Reader.readLabelIDX());
      break;
    case 0x0e:
    {
    ...
    case 0x0f:
      Delegate.onInstReturn();
      break;
    case 0x10:
      Delegate.onInstCall(Reader.readFuncIDX());
      break;
    case 0x11:
    ...
    case 0x1a:
      ...
      break;
    case 0x1b:
      Delegate.onInstSelect();
      break;

#define wasm_dynamic_LOCAL_INSTRUCTION(Opcode, Name) \
  case Opcode:                                       \
    Delegate.onInst##Name(Reader.readLocalIDX());    \
    break;
      wasm_dynamic_LOCAL_INSTRUCTION(0x20, LocalGet)
          wasm_dynamic_LOCAL_INSTRUCTION(0x21, LocalSet)
              wasm_dynamic_LOCAL_INSTRUCTION(0x22, LocalTee)
#undef wasm_dynamic_LOCAL_INSTRUCTION
#define wasm_dynamic_GLOBAL_INSTRUCTION(Opcode, Name) \
  case Opcode:                                        \
    Delegate.onInst##Name(Reader.readGlobalIDX());    \
    break;
                  wasm_dynamic_GLOBAL_INSTRUCTION(0x23, GlobalGet)
                      wasm_dynamic_GLOBAL_INSTRUCTION(0x24, GlobalSet)
#undef wasm_dynamic_GLOBAL_INSTRUCTION

#define wasm_dynamic_MEMORY_INSTRUCTION(Opcode, Name) \
  case Opcode:                                        \
  {                                                   \
    ...
    break;                                            \
                          ...
                          wasm_dynamic_MEMORY_INSTRUCTION(0x28, I32Load)
                              wasm_dynamic_MEMORY_INSTRUCTION(0x29, I64Load)
                                  wasm_dynamic_MEMORY_INSTRUCTION(0x2a, F32Load)
                                      wasm_dynamic_MEMORY_INSTRUCTION(0x2b, F64Load)
                                          wasm_dynamic_MEMORY_INSTRUCTION(0x2c, I32Load8S)
                                              wasm_dynamic_MEMORY_INSTRUCTION(0x2d, I32Load8U)
                                                  wasm_dynamic_MEMORY_INSTRUCTION(0x2e, I32Load16S)
                                                      wasm_dynamic_MEMORY_INSTRUCTION(0x2f, I32Load16U)
                                                          wasm_dynamic_MEMORY_INSTRUCTION(0x30, I64Load8S)
                                                              wasm_dynamic_MEMORY_INSTRUCTION(0x31, I64Load8U)
                                                                  wasm_dynamic_MEMORY_INSTRUCTION(0x32, I64Load16S)
                                                                      wasm_dynamic_MEMORY_INSTRUCTION(0x33, I64Load16U)
                                                                          wasm_dynamic_MEMORY_INSTRUCTION(0x34, I64Load32S)
                                                                              wasm_dynamic_MEMORY_INSTRUCTION(0x35, I64Load32U)
                                                                                  wasm_dynamic_MEMORY_INSTRUCTION(0x36, I32Store)
                                                                                      wasm_dynamic_MEMORY_INSTRUCTION(0x37, I64Store)
                                                                                          wasm_dynamic_MEMORY_INSTRUCTION(0x38, F32Store)
                                                                                              wasm_dynamic_MEMORY_INSTRUCTION(0x39, F64Store)
                                                                                                  wasm_dynamic_MEMORY_INSTRUCTION(0x3a, I32Store8)
                                                                                                      wasm_dynamic_MEMORY_INSTRUCTION(0x3b, I32Store16)
                                                                                                          wasm_dynamic_MEMORY_INSTRUCTION(0x3c, I64Store8)
                                                                                                              wasm_dynamic_MEMORY_INSTRUCTION(0x3d, I64Store16)
                                                                                                                  wasm_dynamic_MEMORY_INSTRUCTION(0x3e, I64Store32)
#undef wasm_dynamic_MEMORY_INSTRUCTION
                                                                                                                      case 0x3f:
      {
    ...
    case 0x41:
      Delegate.onInstI32Const(Reader.readSLEB128Int32());
      break;
    case 0x42:
      Delegate.onInstI64Const(Reader.readSLEB128Int64());
      break;
    case 0x43:
    {
    ...
    case 0x45:
      Delegate.onInstI32Eqz();
      break;
    case 0x46:
      Delegate.onInstI32Eq();
      break;
    case 0x47:
      Delegate.onInstI32Ne();
      break;
    case 0x48:
      Delegate.onInstI32LtS();
      break;
    case 0x49:
      Delegate.onInstI32LtU();
      break;
    case 0x4a:
      Delegate.onInstI32GtS();
      break;
    case 0x4b:
      Delegate.onInstI32GtU();
      break;
    case 0x4c:
      Delegate.onInstI32LeS();
      break;
    case 0x4d:
      Delegate.onInstI32LeU();
      break;
    case 0x4e:
      Delegate.onInstI32GeS();
      break;
    case 0x4f:
      Delegate.onInstI32GeU();
      break;

    case 0x50:
      Delegate.onInstI64Eqz();
      break;
    case 0x51:
      Delegate.onInstI64Eq();
      break;
    case 0x52:
      Delegate.onInstI64Ne();
      break;
    case 0x53:
      Delegate.onInstI64LtS();
      break;
    case 0x54:
      Delegate.onInstI64LtU();
      break;
    case 0x55:
      Delegate.onInstI64GtS();
      break;
    case 0x56:
      Delegate.onInstI64GtU();
      break;
    case 0x57:
      Delegate.onInstI64LeS();
      break;
    case 0x58:
      Delegate.onInstI64LeU();
      break;
    case 0x59:
      Delegate.onInstI64GeS();
      break;
    case 0x5a:
      Delegate.onInstI64GeU();
      break;

    case 0x5b:
      Delegate.onInstF32Eq();
      break;
    case 0x5c:
      Delegate.onInstF32Ne();
      break;
    case 0x5d:
      Delegate.onInstF32Lt();
      break;
    case 0x5e:
      Delegate.onInstF32Gt();
      break;
    case 0x5f:
      Delegate.onInstF32Le();
      break;
    case 0x60:
      Delegate.onInstF32Ge();
      break;

    case 0x61:
      Delegate.onInstF64Eq();
      break;
    case 0x62:
      Delegate.onInstF64Ne();
      break;
    case 0x63:
      Delegate.onInstF64Lt();
      break;
    case 0x64:
      Delegate.onInstF64Gt();
      break;
    case 0x65:
      Delegate.onInstF64Le();
      break;
    case 0x66:
      Delegate.onInstF64Ge();
      break;

    case 0x67:
      Delegate.onInstI32Clz();
      break;
    case 0x68:
      Delegate.onInstI32Ctz();
      break;
    case 0x69:
      Delegate.onInstI32Popcnt();
      break;
    case 0x6a:
      Delegate.onInstI32Add();
      break;
    case 0x6b:
      Delegate.onInstI32Sub();
      break;
    case 0x6c:
      Delegate.onInstI32Mul();
      break;
    case 0x6d:
      Delegate.onInstI32DivS();
      break;
    case 0x6e:
      Delegate.onInstI32DivU();
      break;
    case 0x6f:
      Delegate.onInstI32RemS();
      break;
    case 0x70:
      Delegate.onInstI32RemU();
      break;
    case 0x71:
      Delegate.onInstI32And();
      break;
    case 0x72:
      Delegate.onInstI32Or();
      break;
    case 0x73:
      Delegate.onInstI32Xor();
      break;
    case 0x74:
      Delegate.onInstI32Shl();
      break;
    case 0x75:
      Delegate.onInstI32ShrS();
      break;
    case 0x76:
      Delegate.onInstI32ShrU();
      break;
    case 0x77:
      Delegate.onInstI32Rotl();
      break;
    case 0x78:
      Delegate.onInstI32Rotr();
      break;

    case 0x79:
      Delegate.onInstI64Clz();
      break;
    case 0x7a:
      Delegate.onInstI64Ctz();
      break;
    case 0x7b:
      Delegate.onInstI64Popcnt();
      break;
    case 0x7c:
      Delegate.onInstI64Add();
      break;
    case 0x7d:
      Delegate.onInstI64Sub();
      break;
    case 0x7e:
      Delegate.onInstI64Mul();
      break;
    case 0x7f:
      Delegate.onInstI64DivS();
      break;
    case 0x80:
      Delegate.onInstI64DivU();
      break;
    case 0x81:
      Delegate.onInstI64RemS();
      break;
    case 0x82:
      Delegate.onInstI64RemU();
      break;
    case 0x83:
      Delegate.onInstI64And();
      break;
    case 0x84:
      Delegate.onInstI64Or();
      break;
    case 0x85:
      Delegate.onInstI64Xor();
      break;
    case 0x86:
      Delegate.onInstI64Shl();
      break;
    case 0x87:
      Delegate.onInstI64ShrS();
      break;
    case 0x88:
      Delegate.onInstI64ShrU();
      break;
    case 0x89:
      Delegate.onInstI64Rotl();
      break;
    case 0x8a:
      Delegate.onInstI64Rotr();
      break;

    case 0x8b:
      Delegate.onInstF32Abs();
      break;
    case 0x8c:
      Delegate.onInstF32Neg();
      break;
    case 0x8d:
      Delegate.onInstF32Ceil();
      break;
    case 0x8e:
      Delegate.onInstF32Floor();
      break;
    case 0x8f:
      Delegate.onInstF32Trunc();
      break;
    case 0x90:
      Delegate.onInstF32Nearest();
      break;
    case 0x91:
      Delegate.onInstF32Sqrt();
      break;
    case 0x92:
      Delegate.onInstF32Add();
      break;
    case 0x93:
      Delegate.onInstF32Sub();
      break;
    case 0x94:
      Delegate.onInstF32Mul();
      break;
    case 0x95:
      Delegate.onInstF32Div();
      break;
    case 0x96:
      Delegate.onInstF32Min();
      break;
    case 0x97:
      Delegate.onInstF32Max();
      break;
    case 0x98:
      Delegate.onInstF32CopySign();
      break;

    case 0x99:
      Delegate.onInstF64Abs();
      break;
    case 0x9a:
      Delegate.onInstF64Neg();
      break;
    case 0x9b:
      Delegate.onInstF64Ceil();
      break;
    case 0x9c:
      Delegate.onInstF64Floor();
      break;
    case 0x9d:
      Delegate.onInstF64Trunc();
      break;
    case 0x9e:
      Delegate.onInstF64Nearest();
      break;
    case 0x9f:
      Delegate.onInstF64Sqrt();
      break;
    case 0xa0:
      Delegate.onInstF64Add();
      break;
    case 0xa1:
      Delegate.onInstF64Sub();
      break;
    case 0xa2:
      Delegate.onInstF64Mul();
      break;
    case 0xa3:
      Delegate.onInstF64Div();
      break;
    case 0xa4:
      Delegate.onInstF64Min();
      break;
    case 0xa5:
      Delegate.onInstF64Max();
      break;
    case 0xa6:
      Delegate.onInstF64CopySign();
      break;

    case 0xa7:
      Delegate.onInstI32WrapI64();
      break;
    case 0xa8:
      Delegate.onInstI32TruncF32S();
      break;
    case 0xa9:
      Delegate.onInstI32TruncF32U();
      break;
    case 0xaa:
      Delegate.onInstI32TruncF64S();
      break;
    case 0xab:
      Delegate.onInstI32TruncF64U();
      break;
    case 0xac:
      Delegate.onInstI64ExtendI32S();
      break;
    case 0xad:
      Delegate.onInstI64ExtendI32U();
      break;
    case 0xae:
      Delegate.onInstI64TruncF32S();
      break;
    case 0xaf:
      Delegate.onInstI64TruncF32U();
      break;
    case 0xb0:
      Delegate.onInstI64TruncF64S();
      break;
    case 0xb1:
      Delegate.onInstI64TruncF64U();
      break;
    case 0xb2:
      Delegate.onInstF32ConvertI32S();
      break;
    case 0xb3:
      Delegate.onInstF32ConvertI32U();
      break;
    case 0xb4:
      Delegate.onInstF32ConvertI64S();
      break;
    case 0xb5:
      Delegate.onInstF32ConvertI64U();
      break;
    case 0xb6:
      Delegate.onInstF32DemoteF64();
      break;
    case 0xb7:
      Delegate.onInstF64ConvertI32S();
      break;
    case 0xb8:
      Delegate.onInstF64ConvertI32U();
      break;
    case 0xb9:
      Delegate.onInstF64ConvertI64S();
      break;
    case 0xba:
      Delegate.onInstF64ConvertI64U();
      break;
    case 0xbb:
      Delegate.onInstF64PromoteF32();
      break;
    case 0xbc:
      Delegate.onInstI32ReinterpretF32();
      break;
    case 0xbd:
      Delegate.onInstI64ReinterpretF64();
      break;
    case 0xbe:
      Delegate.onInstF32ReinterpretI32();
      break;
    case 0xbf:
      Delegate.onInstF64ReinterpretI64();
      break;

    case 0xc0:
      Delegate.onInstI32Extend8S();
      break;
    case 0xc1:
      Delegate.onInstI32Extend16S();
      break;
    case 0xc2:
      Delegate.onInstI64Extend8S();
      break;
    case 0xc3:
      Delegate.onInstI64Extend16S();
      break;
    case 0xc4:
      Delegate.onInstI64Extend32S();
      break;
    ...
    case 0xfc:
    {
      ...
      {
      case 0x00:
        Delegate.onInstI32TruncSatF32S();
        break;
      case 0x01:
        Delegate.onInstI32TruncSatF32U();
        break;
      case 0x02:
        Delegate.onInstI32TruncSatF64S();
        break;
      case 0x03:
        Delegate.onInstI32TruncSatF64U();
        break;
      case 0x04:
        Delegate.onInstI64TruncSatF32S();
        break;
      case 0x05:
        Delegate.onInstI64TruncSatF32U();
        break;
      case 0x06:
        Delegate.onInstI64TruncSatF64S();
        break;
      case 0x07:
        Delegate.onInstI64TruncSatF64U();
        break;
      default:
        throw ParserError(fmt::format(
