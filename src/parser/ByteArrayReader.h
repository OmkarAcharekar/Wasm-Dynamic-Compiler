#ifndef wasm_dynamic_INCLUDE_GUARD_PARSER_BYTE_ARRAY_READER
#define wasm_dynamic_INCLUDE_GUARD_PARSER_BYTE_ARRAY_READER
...
namespace parser
{
  ...
  public:
    ...
    {
      if (Barrier.has_value() && (Cursor >= *Barrier))
        return false;
