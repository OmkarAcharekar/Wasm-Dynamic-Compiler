#ifndef wasm_dynamic_INCLUDE_GUARD_PARSER_EXPR_BUILDER_DELEGATE
#define wasm_dynamic_INCLUDE_GUARD_PARSER_EXPR_BUILDER_DELEGATE
...
#undef wasm_dynamic_SKIP_SECTION_EVENTS

    bytecode::Expression &getExpression()
    {
      return CExpr;
    }
  };
