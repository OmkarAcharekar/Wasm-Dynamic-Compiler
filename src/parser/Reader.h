#ifndef wasm_dynamic_INCLUDE_GUARD_PARSER_READER
#define wasm_dynamic_INCLUDE_GUARD_PARSER_READER
...
concept reader = requires(T R) {
  ...
  class WASMReader
  {
    ...
    static constexpr auto ceil(double Number) -> T
    {
  ...
  bytecode::GlobalType WASMReader<ReaderImpl>::readGlobalType()
  {
    ...
    {
    case 0x00:
      return bytecode::GlobalType(bytecode::MutabilityKind::Const, Type);
    case 0x01:
      return bytecode::GlobalType(bytecode::MutabilityKind::Var, Type);
    default:
      throw ParserError(fmt::format(
